            ...
            <Form>
                ...
                {submited ? (<Alert color="success"><br /><br /><br /><br />
                    <center>เพิ่มรายล่ะเอียดข้อมูลการศึกษาต่อสำเร็จ!<br /><br /><br /><br /><br />
                        <Button color="btn btn-success" onClick={newEdudetail}>OK</Button></center>
                </Alert>
                ) : (
                    <Form >
                        ...
                        <Row>
                            ...
                            <Col xs="3">
                                <FormGroup>
                                    <Label for="GPA">เกรดที่กำหนด</Label>
                            ...
                            <Col xs="6">
                                <FormGroup>
                                    <Label for="curriculum_edu">เงื่อนไขด้านสายการเรียน</Label>
                            ...
                            <Col xs="6">
                                <FormGroup>
                                    ...
                                    <Input type="select" name="id_course" id="id_course" value={edudetail.id_course || ""}
                                        onChange={handleInputChange}>
                                        {course.map((course) => {
                                            return (
